...
discription = pd.read_csv("datasets/description.csv")
...
def helper(pr):
  ...
  wrkout = work_out[work_out['disease'] == pr] ['workout']
...
def home():
    if request.method == 'POST':
        ...
        # print(mysysms)
        print(symptoms)
        user_list=(i.strip() for i in symptoms.split(','))
        if not all(ele in symptoms_dict.keys() for ele in user_list):
            message = "The Symptoms you have enter is incorrect please enter valid "
